...
*What the user can expect: the user will be able to create 1 of 5 different types of Pokémon of their choosing. They will have various ways to interact with their Pokémon from a menu that will then execute the option they chose.
